...
chars = {
	...
	"!": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_1, 0, 0, 0, 0, 0]),
	"@": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_2, 0, 0, 0, 0, 0]),
	"#": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_3, 0, 0, 0, 0, 0]),
	"$": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_4, 0, 0, 0, 0, 0]),
	"%": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_5, 0, 0, 0, 0, 0]),
	"^": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_6, 0, 0, 0, 0, 0]),
	"&": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_7, 0, 0, 0, 0, 0]),
	"*": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_8, 0, 0, 0, 0, 0]),
	"(": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_9, 0, 0, 0, 0, 0]),
	")": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_0, 0, 0, 0, 0, 0]),
	...
	"\\": bytes([0, 0, keyboard.KEY_7, 0, 0, 0, 0, 0]),
	",": bytes([0, 0, keyboard.KEY_COMMA, 0, 0, 0, 0, 0]),
	".": bytes([0, 0, keyboard.KEY_PERIOD, 0, 0, 0, 0, 0]),
	"/": bytes([0, 0, keyboard.KEY_SLASH, 0, 0, 0, 0, 0]),


	"_": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_MINUS, 0, 0, 0, 0, 0]),
	"+": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_EQUAL, 0, 0, 0, 0, 0]),
	"{": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_LEFT_BRACE, 0, 0, 0, 0, 0]),
	"}": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_RIGHT_BRACE, 0, 0, 0, 0, 0]),
	":": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_SEMICOLON, 0, 0, 0, 0, 0]),
	"\"": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_QUOTE, 0, 0, 0, 0, 0]),
	"|": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_6, 0, 0, 0, 0, 0]),
	...
	"?": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_SLASH, 0, 0, 0, 0, 0]),
	
	"~": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_TILDE, 0, 0, 0, 0, 0]),
