...
chars = {
	...
	"a": bytes([0, 0, keyboard.KEY_Q, 0, 0, 0, 0, 0]),
	...
	"w": bytes([0, 0, keyboard.KEY_Z, 0, 0, 0, 0, 0]),
	"x": bytes([0, 0, keyboard.KEY_X, 0, 0, 0, 0, 0]),
	"y": bytes([0, 0, keyboard.KEY_Y, 0, 0, 0, 0, 0]),
	"z": bytes([0, 0, keyboard.KEY_W, 0, 0, 0, 0, 0]),

	"A": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_Q, 0, 0, 0, 0, 0]),
	...
	"M": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_SEMICOLON, 0, 0, 0, 0, 0]),
	...
	"Q": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_A, 0, 0, 0, 0, 0]),
	...
	"W": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_Z, 0, 0, 0, 0, 0]),
	...
	"Z": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_W, 0, 0, 0, 0, 0]),

	"1": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_1, 0, 0, 0, 0, 0]),
	"2": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_2, 0, 0, 0, 0, 0]),
	"3": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_3, 0, 0, 0, 0, 0]),
	"4": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_4, 0, 0, 0, 0, 0]),
	"5": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_5, 0, 0, 0, 0, 0]),
	"6": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_6, 0, 0, 0, 0, 0]),
	"7": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_7, 0, 0, 0, 0, 0]),
	"8": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_8, 0, 0, 0, 0, 0]),
	"9": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_9, 0, 0, 0, 0, 0]),
	"0": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_0, 0, 0, 0, 0, 0]),


	"-": bytes([0, 0, keyboard.KEY_EQUAL, 0, 0, 0, 0, 0]),
	"=": bytes([0, 0, keyboard.KEY_EQUAL, 0, 0, 0, 0, 0]),
	"[": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_RIGHT_BRACE, 0, 0, 0, 0, 0]),
	"]": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_LEFT_BRACE, 0, 0, 0, 0, 0]),
	";": bytes([0, 0, keyboard.KEY_COMMA, 0, 0, 0, 0, 0]),
	"'": bytes([0, 0, keyboard.KEY_4, 0, 0, 0, 0, 0]),
	"\\": bytes([keyboard.MODIFIERKEY_RIGHT_ALT + keyboard.MODIFIERKEY_LEFT_CTRL, 0, KEY_NON_US_100, 0, 0, 0, 0, 0]),
	",": bytes([0, 0, keyboard.KEY_M, 0, 0, 0, 0, 0]),
	".": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_COMMA, 0, 0, 0, 0, 0]),
	"/": bytes([keyboard.MODIFIERKEY_LEFT_SHIFT, 0, keyboard.KEY_PERIOD, 0, 0, 0, 0, 0]),



	"!": bytes([0, 0, keyboard.KEY_8, 0, 0, 0, 0, 0]),
	"\"": bytes([0, 0, keyboard.KEY_3, 0, 0, 0, 0, 0]),
	"#": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_3, 0, 0, 0, 0, 0]),
	"$": bytes([0, 0, keyboard.KEY_RIGHT_BRACE, 0, 0, 0, 0, 0]),
	"%": bytes([keyboard.MODIFIERKEY_SHIFT, 0, keyboard.KEY_QUOTE, 0, 0, 0, 0, 0]),
	"&": bytes([0, 0, keyboard.KEY_1, 0, 0, 0, 0, 0]),
	"(": bytes([0, 0, keyboard.KEY_5, 0, 0, 0, 0, 0]),
	...
	"<": bytes([0, 0, KEY_NON_US_100, 0, 0, 0, 0, 0]),
	"=": bytes([0, 0, keyboard.KEY_SLASH, 0, 0, 0, 0, 0]),
	">": bytes([keyboard.MODIFIERKEY_SHIFT, 0, KEY_NON_US_100, 0, 0, 0, 0, 0]),
	"?": bytes([keyboard.MODIFIERKEY_SHIFT, 0, keyboard.KEY_M, 0, 0, 0, 0, 0]),
	"@": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_2, 0, 0, 0, 0, 0]),

	"^": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_6, 0, 0, 0, 0, 0]),
	"_": bytes([keyboard.MODIFIERKEY_SHIFT, 0, keyboard.KEY_EQUAL, 0, 0, 0, 0, 0]),
	"`": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_BACKSLASH, 0, 0, 0, 0, 0]), # Not tested
	"{": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_9, 0, 0, 0, 0, 0]),
	"|": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_1, 0, 0, 0, 0, 0]),
	"}": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_0, 0, 0, 0, 0, 0]),
	"~": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_SLASH, 0, 0, 0, 0, 0]),


	"£": bytes([keyboard.MODIFIERKEY_SHIFT, 0, keyboard.KEY_BACKSLASH, 0, 0, 0, 0, 0]),
	"§": bytes([0, 0, keyboard.KEY_6, 0, 0, 0, 0, 0]),
	"°": bytes([keyboard.MODIFIERKEY_SHIFT, 0, keyboard.KEY_MINUS, 0, 0, 0, 0, 0]),
	"²": bytes([0, 0, keyboard.KEY_TILDE, 0, 0, 0, 0, 0]),
	"³": bytes([keyboard.MODIFIERKEY_SHIFT, 0, keyboard.KEY_TILDE, 0, 0, 0, 0, 0]),
	#"´": bytes([0, 0, keyboard.ACUTE_ACCENT_BITS, keyboard.KEY_SPACE, 0, 0, 0, 0]),
	"µ": bytes([0, 0, keyboard.KEY_BACKSLASH, 0, 0, 0, 0, 0]),
	"à": bytes([0, 0, keyboard.KEY_0, 0, 0, 0, 0, 0]),
	"ç": bytes([0, 0, keyboard.KEY_9, 0, 0, 0, 0, 0]),
	"è": bytes([0, 0, keyboard.KEY_7, 0, 0, 0, 0, 0]),
	"é": bytes([0, 0, keyboard.KEY_2, 0, 0, 0, 0, 0]),
	"ù": bytes([0, 0, keyboard.KEY_QUOTE, 0, 0, 0, 0, 0]),
	"€": bytes([keyboard.MODIFIERKEY_RIGHT_ALT, 0, keyboard.KEY_E, 0, 0, 0, 0, 0]),
